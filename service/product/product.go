...
func (s service) Products(params ProductsQueryParams) (items []entity.Product, isLastPage bool, err error) {
...
func (s service) Product(id int) (item entity.Product, err error) {
	var res entity.Product
